    ...
    render() {
        return <div>
            ...
            <div className="columns is-multiline">
                <WorkSample title="Responsive Blog Design" link="https://ragens9.github.io/d2-recreate-a-responsive-blog/" description="I re-created a responsive blog using HTML, CSS, and media queries." screenshot="./img/ragensanner_responsiveblogsmall.jpg" />
